...
const PROFILES: MatchProfile[] = [
  ...
  {
    id: 2, name: 'Maya Patel', age: 27, location: 'Waterloo, ON',
    occupation: 'Data Scientist at Google', initials: 'MP',
    bio: 'Bookworm by day, foodie by night. Always up for a spontaneous road trip.',
    interests: ['Reading', 'Cooking', 'Travel', 'Yoga'],
    compatibility: 89, gradient: 'linear-gradient(135deg, #8b5cf6, #ec4899)',
  },
  {
    id: 3, name: 'Emily Rivera', age: 25, location: 'Vancouver, BC',
    occupation: 'Frontend Dev at Stripe', initials: 'ER',
    ...
    compatibility: 87, gradient: 'linear-gradient(135deg, #06b6d4, #3b82f6)',
  },
  {
    id: 4, name: 'Jordan Lee', age: 29, location: 'Montreal, QC',
    occupation: 'Product Manager at Shopify', initials: 'JL',
    bio: 'Passionate about tech, sustainability, and great conversation over good food.',
    interests: ['Gaming', 'Cooking', 'Travel', 'Movies'],
    compatibility: 82, gradient: 'linear-gradient(135deg, #10b981, #14b8a6)',
  },
];
        ...
        <div className={`profile-card-stack ${profiles.length > 1 ? `swiping-${swipeDirection}` : ''}`}>
          ...
          {profiles[1] && (
            <div className="profile-card next-card">
              <div className="card-avatar" style={{ background: profiles[1].gradient }}>
          ...
          <div className="profile-card current-card">
            <div className="card-avatar" style={{ background: currentProfile.gradient }}>
            ...
            <div className="card-body">
              ...
              <div className="card-interests">
                {currentProfile.interests.map(i => (
                  <span key={i} className="card-interest-tag">{i}</span>
                ))}
              </div>
            </div>
          </div>
